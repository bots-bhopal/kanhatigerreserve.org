...
class FrontendController extends Controller
{
    ...
    {
        $links = Links::orderBy('updated_at', 'DESC')->get();
        return view('frontend.pages.link.links')->with(['links' => $links]);
    }
    ...
    public function index()
    {
        ...
        // $all_visitor_images = MonthPhoto::where('lang', $lang)->get();
        $all_visitor_images = MonthPhoto::where('lang', $lang)->orderBy('updated_at', 'DESC')->latest()->first();
        $all_gallery_images = ImageGallery::take(10)->get();
        $all_links = Links::orderBy('updated_at', 'DESC')->get();
