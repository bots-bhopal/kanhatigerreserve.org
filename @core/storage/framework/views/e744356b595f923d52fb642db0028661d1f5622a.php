...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Total Visitors Page')); ?>
...
<?php endif; ?> 
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-5">
                            <div class="card-body">
                                <h4 class="header-title"><?php echo e(__('Total Number of Visitors')); ?></h4>
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <?php $a=0; ?>
                                    <?php $__currentLoopData = $visitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="nav-item">
                                    ...
                                    <div class="table-wrap table-responsive">
                                        <table class="table table-default" id="all_docs_table">
                                            <thead>
                                                ...
                                                <th><?php echo e(__('Visitors Count')); ?></th>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $visitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $visitor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($visitor->visitors_count); ?></td>
                                                        <td class="text-center">
                                                            <a href="<?php echo e(route('admin.visitor.edit', $visitor->id)); ?>"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\kanhatigerreserve.org\@core\resources\views/backend/pages/visitor/index.blade.php ENDPATH**/ ?>