...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'HtmlMinifier']], function () {
    ...
    ---------------------------------------*/
    Route::get($notice_page_slug, 'FrontendController@notice_page')->name('frontend.notice');
    ...
    ---------------------------------------*/
    Route::get($link_page_slug, 'FrontendController@link_page')->name('frontend.link');
