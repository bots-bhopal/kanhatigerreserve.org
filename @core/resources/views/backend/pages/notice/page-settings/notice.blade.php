    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ __('Notice Or Order Page Settings') }}</h4>
                                ...
                                @foreach ($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if ($key == 0) show active @endif"
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="notice_page_{{ $lang->slug }}_read_more_btn_text">{{ __('Notice & Order Read More Text') }}</label>
                                            <input type="text" class="form-control"
                                                ...
                                                placeholder="{{ __('Notice & Order Read More Text') }}">
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div class="form-group">
                                <label for="blog_page_item">{{ __('Notice & Orders Items') }}</label>
                                <input type="text" class="form-control" id="notice_page_item"
                                    value="{{ get_static_option('notice_page_item') }}" name="notice_page_item"
                                    placeholder="{{ __('Notice or Order Items') }}">
                                <small
                                    class="text-danger">{{ __('Enter how many notices or orders you want to show in Notice or Order page') }}</small>
                            </div>
                            <button type="submit"
                                class="btn btn-primary mt-4 pr-4 pl-4">{{ __('Update Notice or Order Page Settings') }}</button>
                        </form>
                    </div>
                </div>
            </div>
