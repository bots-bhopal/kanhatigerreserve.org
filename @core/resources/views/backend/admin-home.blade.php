            ...
            <div class="col-lg-12">
                    ...
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                                ...
                                <div class="content">
                                    <span class="total">{{$document_count}}</span>
                ...
                @if(check_page_permission_by_string('Notice Manage'))
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                                <a href="{{route('admin.notice.new')}}" class="add-new"><i class="ti-plus"></i></a>
                                <div class="icon">
                                    <i class="ti-blackboard"></i>
                                </div>
                                <div class="content">
                                    <span class="total">{{$notice_count}}</span>
                                    <h4 class="title">{{__('Total Notices & Orders')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
