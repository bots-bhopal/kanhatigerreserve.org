            ...
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    @if (check_page_permission_by_string('Notice Manage'))
                        ...
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Notices & Orders') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/notice') }}"><a
                                        href="{{ route('admin.notice') }}">{{ __('All Notices & Orders') }}</a></li>
                                <li class="{{ active_menu('admin-home/notice/new') }}"><a
                                        href="{{ route('admin.notice.new') }}">{{ __('Add New Notice or Order') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/notice/page-settings') }}"><a
                                        href="{{ route('admin.notice.page.settings') }}">{{ __('Notice or Order Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if (check_page_permission_by_string('Link Manage'))
                        ...
                        ">
                            ...
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/link') }}"><a
                                        href="{{ route('admin.links') }}">{{ __('All Important Notifications') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/link/new-category') }}"><a
                                        href="{{ route('admin.category.new') }}">{{ __('Add New Category') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/link/new') }}"><a
                                        href="{{ route('admin.link.new') }}">{{ __('Add Important Notifications') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if (check_page_permission_by_string('Photo Manage'))
                        ...
                        @if (request()->is('admin-home/photo-page/*')) active @endif
                                ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Visitor Month Pic') }}</span></a>
                            <ul class="collapse">
